...
abstract class DashboardRemoteDataSource {
  ...
  Future<void> addExpense(String flatId, String title, double amount, String payerId, String payerName, String category);
  Future<void> settleDebt(String flatId, String debtId, String userId, String userName);
